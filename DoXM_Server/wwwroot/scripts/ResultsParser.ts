...
export function CreateCommandHarness(context: CommandContext): HTMLDivElement {
    ...
    commandHarness.innerHTML = `
        <div class="command-harness-title">
            ...
            <button class="btn btn-xs btn-default" data-toggle="collapse" data-target="#${context.ID}-results">View</button> 
            <a class="btn btn-xs btn-default" target="_blank" href="${location.origin}/API/Commands/JSON/${context.ID}">JSON</a>
            <a class="btn btn-xs btn-default" target="_blank" href="${location.origin}/API/Commands/XML/${context.ID}">XML</a> 
        </div>
...
export function AddPSCoreResultsHarness(result: PSCoreCommandResult) {
    ...
    resultDiv.innerHTML = `
        <div class="result-header">
                ...
                <button class="btn btn-xs btn-default" data-toggle="collapse" data-target="#${result.CommandContextID + result.MachineID}-result">View</button>
        </div>
