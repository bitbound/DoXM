...
var commands = [
    ...
    new ConsoleCommand("RemoteControl", [], "Connect to a computer with DoXM Remote Control.", "list", "", () => {
        var selectedMachines = Main.DataGrid.GetSelectedMachines();
        if (selectedMachines.length == 0) {
    ...
    new ConsoleCommand("Uninstall", [], "Uninstalls the DoXM client from the selected machines.  Warning: This can't be undone from the web portal.  You would need to redeploy the client.", "uninstall", "", (parameters, parameterDict) => {
...
export const DoXMCommands = commands;
//# sourceMappingURL=DoXMCommands.js.map