...
export function GetCommandModeShortcut() {
    switch (UI.ConsoleTextArea.value.toLowerCase()) {
        case UserSettings.CommandModeShortcuts.DoXM:
            return "DoXM";
...
export function ProcessCommand() {
    ...
    switch (commandMode) {
        case "DoXM":
            var matchingCommand = DoXMCommands.find(x => x.Name.toLowerCase() == commandText.split(" ")[0].toLowerCase());
            if (matchingCommand) {
