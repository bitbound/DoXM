...
namespace DoXM_Server.Migrations
{
    ...
    [Migration("20181022202009_ServerVerificationToken")]
    partial class ServerVerificationToken
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoXM_Library.Models.DoXMUserOptions", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("CommandModeShortcutDoXM")
                        .HasMaxLength(10);
            ...
            modelBuilder.Entity("DoXM_Library.Models.Drive", b =>
                {
                    b.HasOne("DoXM_Library.Models.Machine")
                        .WithMany("Drives")
